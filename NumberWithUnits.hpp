...
namespace ariel {
    ...
    class NumberWithUnits {
        ...
        public:
            ...
            friend NumberWithUnits operator++(NumberWithUnits& unit_num); // ++ operator
            friend NumberWithUnits operator++(NumberWithUnits& unit_num, int); // ++ operator
            friend NumberWithUnits operator+=(NumberWithUnits& unit_num_1, const NumberWithUnits& unit_num_2); // += operator
